...
- (void)drawTitle
{
    ...
    [title drawAtPoint:CGPointMake(0, -2.0f) withAttributes:@{ NSFontAttributeName: [SSStyles lightFontOfSize:14.0f], NSForegroundColorAttributeName: [UIColor colorWithHexString:COLOR_SECONDARY] }];
}
