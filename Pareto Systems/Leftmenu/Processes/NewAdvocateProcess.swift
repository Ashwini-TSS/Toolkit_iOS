...
class NewAdvocateProcess: UIViewController {
    ...
    @IBAction func tappedSave(_ sender: Any) {
        ...
        let dataObj:NSMutableDictionary = [:]
        dataObj.setValue(fieldName.text!, forKey: "Name")
        dataObj.setValue(fieldDescription.text!, forKey: "Description")
        ...
        if processList != nil {
            mainURL = modifyURL
            dataObj.setValue(processList.createdBy, forKey: "CreatedBy")
            dataObj.setValue(processList.modifiedOn, forKey: "ModifiedOn")
            dataObj.setValue(processList.createdOn, forKey: "CreatedOn")
            dataObj.setValue(processList.id, forKey: "Id")
            dataObj.setValue(processList.modifiedBy, forKey: "ModifiedBy")

        }else{
            mainURL = createContact
        }
        json = ["DataObject": dataObj,
...
extension NewAdvocateProcess:URLSessionDelegate {
