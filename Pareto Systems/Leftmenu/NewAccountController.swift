...
class NewAccountController: UITableViewController,TextInputFieldDelegate {
    ...
    @IBOutlet weak var email2Field: ACFloatingTextfield!
    ...
    @IBOutlet weak var otherField: ACFloatingTextfield!
    @IBOutlet weak var mobileField: ACFloatingTextfield!
    @IBOutlet weak var secondayField: ACFloatingTextfield!
    @IBOutlet weak var primaryField: ACFloatingTextfield!
    @IBOutlet weak var descriptionField: KMPlaceholderTextView!
    @IBOutlet weak var legalNameField: ACFloatingTextfield!
