...
class DetailContactController: UITableViewController {

    var contactList:ContactListResult!
    var orgID:String = ""
    
    @IBOutlet weak var firsnameField: ACFloatingTextfield!
    @IBOutlet weak var lastnameField: ACFloatingTextfield!
    @IBOutlet weak var middleNameField: ACFloatingTextfield!
    ...
    @IBOutlet weak var addressLine1Field: ACFloatingTextfield!
    @IBOutlet weak var genderField: ACFloatingTextfield!
    @IBOutlet weak var mobilePhoneField: ACFloatingTextfield!
    @IBOutlet weak var companyNameField: ACFloatingTextfield!
    ...
    override func viewDidLoad() {
        ...
        if contactList != nil {
            firsnameField.text = contactList.firstName
            lastnameField.text = contactList.lastName
            middleNameField.text = contactList.middleName
            fullnameField.text = contactList.fullName
            postalField.text = contactList.postal
            emailAddressField.text = contactList.eMailAddress1
            addressLine1Field.text = contactList.addressLine1
            genderField.text = contactList.gender
//            mobilePhoneField.text = contactList.mobilePhone
            
            
            mobilePhoneField.text = NavigationHelper.USPhoneFormat(number: contactList.mobilePhone)
            
            companyNameField.text = contactList.companyName
...
extension DetailContactController:URLSessionDelegate {
