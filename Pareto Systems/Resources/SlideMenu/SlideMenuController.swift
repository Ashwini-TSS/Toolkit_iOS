...
//        self.direc
    ...
    open func initView() {
        ...
        SlideMenuOptions.leftViewWidth = UIScreen.main.bounds.width - 40
      ...
      if rightViewController != nil {
        ...
        changeLeftViewWidth(view.bounds.width - 40)
    }
    ...
    open override var preferredStatusBarStyle: UIStatusBarStyle {
        //self.mainViewController?.preferredStatusBarStyle ?? .lightContent
        return .lightContent
    }
    ...
    open override func toggleLeft() {
        ...
        //        let backImage = UIImage(named: "ic_back_arrow")?.withRenderingMode(.alwaysOriginal)
...
extension UIViewController {
    ...
    public func addPriorityToMenuGesuture(_ targetScrollView: UIScrollView) {
        targetScrollView.isDirectionalLockEnabled = true
