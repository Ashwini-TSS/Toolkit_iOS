//
//	getOrganizationClassModel.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class getOrganizationClassModel : NSObject, NSCoding{

	var responseMessage : String!
	var results : [getOrganizationResult]!
	var valid : Bool!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [getOrganizationResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = getOrganizationResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [getOrganizationResult]
