...
class GetAccountsListResult : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: [String:Any]){
        ...
        telePhone1Ext = dictionary["Telephone1Ext"] as? String ?? ""
	}
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
        ...
        telePhone1Ext = aDecoder.decodeObject(forKey: "Telephone1Ext") as? String ?? ""
