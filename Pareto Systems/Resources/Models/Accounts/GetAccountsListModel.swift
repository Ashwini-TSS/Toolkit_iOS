//
//	GetAccountsListModel.swift
//
//	Create by thabresh thabu on 17/7/2018
...
class GetAccountsListModel : NSObject, NSCoding{

	var responseMessage : String!
	var results : [GetAccountsListResult]!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [GetAccountsListResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = GetAccountsListResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [GetAccountsListResult]
