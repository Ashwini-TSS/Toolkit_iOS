//
//	companyAccountResult.swift
//
//	Create by thabresh thabu on 7/11/2018
...
class companyAccountResult : NSObject, NSCoding{
	...
	var letterheadLogoId : AnyObject!
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		letterheadLogoId = dictionary["LetterheadLogoId"] as? AnyObject
	...
	func toDictionary() -> [String:Any]
	{
		...
		if letterheadLogoId != nil{
			dictionary["LetterheadLogoId"] = letterheadLogoId
		}
		if mobilePhone != nil{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         letterheadLogoId = aDecoder.decodeObject(forKey: "LetterheadLogoId") as? AnyObject
    ...
    */
    @objc func encode(with aCoder: NSCoder)
	{
		...
		if letterheadLogoId != nil{
			aCoder.encode(letterheadLogoId, forKey: "LetterheadLogoId")
		}
		if mobilePhone != nil{
