...
class GetIncompleteActivity : NSObject, NSCoding, NSCopying {
    ...
    func copy(with zone: NSZone? = nil) -> Any {
        ...
        let activityCopy =  GetIncompleteActivity(Priority: Priority, PercentComplete: PercentComplete, advocateProcessIndex: advocateProcessIndex, allDay: allDay, appliedAdvocateProcessId: AppliedAdvocateProcessId, complete: complete, createdBy: createdBy, createdOn: createdOn, descriptionField: descriptionField!, endTime: endTime, DueTime: DueTime, id: id, location: location, modifiedBy: modifiedBy, modifiedOn: modifiedOn, recurrenceIndex: recurrenceIndex, recurringActivityId: RecurringActivityId, rollOver: rollOver, startTime: startTime, subject: subject, activity: activity, type: type)
        
        return activityCopy
        
    }
    required init(Priority:String!,PercentComplete:Int!,advocateProcessIndex:Int!,allDay:Bool!
        ,appliedAdvocateProcessId:String!,complete:Bool!,createdBy:String!,createdOn:String!,descriptionField:String!,endTime:String!,DueTime:String!,id:String!,location:String!,modifiedBy:String!, modifiedOn:String!,recurrenceIndex:Int!,recurringActivityId:String!,rollOver:Bool!,startTime:String!,subject:String!,activity:GetIncompleteActivity!,type:String!) {
