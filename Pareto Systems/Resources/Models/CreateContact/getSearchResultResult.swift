...
class getSearchResultResult : NSObject, NSCoding{
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         latitude = aDecoder.decodeObject(forKey: "Latitude") as? Int ?? 0
         ...
         longitude = aDecoder.decodeObject(forKey: "Longitude") as? Int ?? 0
