...
class GetIncompleteModel : NSObject, NSCoding{

	var activities : [GetIncompleteActivity]!
    ...
    */
	...
	{
         activities = aDecoder.decodeObject(forKey :"Activities") as? [GetIncompleteActivity]
