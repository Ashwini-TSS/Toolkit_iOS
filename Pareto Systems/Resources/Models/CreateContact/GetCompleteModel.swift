...
class GetCompleteModel : NSObject, NSCoding{

	var activities : [GetCompleteActivity]!
    ...
    */
	...
	{
         activities = aDecoder.decodeObject(forKey :"Activities") as? [GetCompleteActivity]
