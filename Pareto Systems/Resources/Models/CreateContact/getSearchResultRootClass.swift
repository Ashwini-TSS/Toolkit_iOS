//
//	getSearchResultRootClass.swift
//
...
class getSearchResultRootClass : NSObject, NSCoding{

	var responseMessage : String!
	var results : [getSearchResultResult]!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [getSearchResultResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = getSearchResultResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [getSearchResultResult]
