//
//	GetDefaultPaymentCardsPaymentCard.swift
//
...
class GetDefaultPaymentCardsPaymentCard : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		recipient = dictionary["Recipient"] as? AnyObject
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         recipient = aDecoder.decodeObject(forKey: "Recipient") as? AnyObject
