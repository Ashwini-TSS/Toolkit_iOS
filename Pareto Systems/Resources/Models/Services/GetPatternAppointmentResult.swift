//
//	GetPatternAppointmentResult.swift
//
...
class GetPatternAppointmentResult : NSObject, NSCoding{
	...
	func toDictionary() -> [String:Any]
	{
		...
		if calendarColor != nil{
			dictionary["CalendarColor"] = calendarColor
		}
		if createdBy != nil{
    ...
    */
	...
	{
         calendarColor = aDecoder.decodeObject(forKey: "CalendarColor") as? String ?? ""
    ...
    */
	...
	{
		if calendarColor != nil{
			aCoder.encode(calendarColor, forKey: "CalendarColor")
		}
		if createdBy != nil{
