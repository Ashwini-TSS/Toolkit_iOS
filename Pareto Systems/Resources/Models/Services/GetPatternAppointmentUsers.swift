//
//	GetPatternAppointmentUsers.swift
//
//	Create by thabresh thabu on 7/7/2018
...
class GetPatternAppointmentUsers : NSObject, NSCoding{

	var responseMessage : String!
	var results : [GetPatternAppointmentResult]!
	var valid : Bool!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [GetPatternAppointmentResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = GetPatternAppointmentResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [GetPatternAppointmentResult]
