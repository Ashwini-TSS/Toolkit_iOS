//
//	GetPatternAssigneeResult.swift
//
...
class GetPatternAssigneeResult : NSObject, NSCoding{
	...
	init(fromDictionary dictionary: [String:Any]){
		...
		assistantId = dictionary["AssistantId"] as? String ?? ""
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         assistantId = aDecoder.decodeObject(forKey: "AssistantId") as? String ?? ""
