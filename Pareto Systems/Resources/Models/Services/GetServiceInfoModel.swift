...
class GetServiceInfoModel : NSObject, NSCoding{

	var dataObject : GetServiceInfoDataObject!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let dataObjectData = dictionary["DataObject"] as? [String:Any]{
			dataObject = GetServiceInfoDataObject(fromDictionary: dataObjectData)
		}
    ...
    */
	...
	{
         dataObject = aDecoder.decodeObject(forKey: "DataObject") as? GetServiceInfoDataObject
