...
class GetPatternAssigneeUsers : NSObject, NSCoding{

	var responseMessage : String!
	var results : [GetPatternAssigneeResult]!
	var valid : Bool!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [GetPatternAssigneeResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = GetPatternAssigneeResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [GetPatternAssigneeResult]
