//
//	GetAppointmentTypesModel.swift
//
//	Create by thabresh thabu on 20/7/2018
...
class GetAppointmentTypesModel : NSObject, NSCoding{

	var responseMessage : String!
	var results : [GetAppointmentTypesResult]!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [GetAppointmentTypesResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = GetAppointmentTypesResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [GetAppointmentTypesResult]
