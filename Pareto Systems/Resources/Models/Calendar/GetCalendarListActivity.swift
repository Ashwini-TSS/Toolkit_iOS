...
class GetCalendarListActivity : NSObject, NSCoding, NSCopying{
    ...
    func copy(with zone: NSZone? = nil) -> Any {
        ...
        let copy = GetCalendarListActivity(AppointmentTypeId: appointmentTypeId, Priority: Priority, PercentComplete: PercentComplete, advocateProcessIndex: advocateProcessIndex, allDay: allDay, appliedAdvocateProcessId: appliedAdvocateProcessId, appointmentTypeId: appointmentTypeId, complete: complete, createdBy: createdBy, createdOn: createdOn, descriptionField: descriptionField, endTime: endTime, DueTime: DueTime, id: id, location: location, modifiedBy:modifiedBy , modifiedOn: modifiedOn, recurrenceIndex: recurrenceIndex, recurringActivityId: recurringActivityId, rollOver: rollOver, startTime: startTime, subject: subject, activity: activity , attendees: attendees, type: type)
        return copy
        
    }
    
    required init(AppointmentTypeId:AnyObject!,Priority:String!,PercentComplete:NSNumber!,advocateProcessIndex:Int!,allDay:Bool!
        ,appliedAdvocateProcessId:String!,appointmentTypeId:AnyObject!,complete:Bool!,createdBy:String!,createdOn:String!,descriptionField:String!,endTime:String!,DueTime:String!,id:String!,location:String!,modifiedBy:String!, modifiedOn:String!,recurrenceIndex:Int!,recurringActivityId:AnyObject!,rollOver:Bool!,startTime:String!,subject:String!,activity:GetCalendarListActivity!,attendees:GetCalendarListAttendee!,type:String!) {
