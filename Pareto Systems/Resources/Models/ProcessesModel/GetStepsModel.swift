...
class GetStepsModel : NSObject, NSCoding{

	var responseMessage : String!
	var results : [GetStepsResult]!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [GetStepsResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = GetStepsResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [GetStepsResult]
