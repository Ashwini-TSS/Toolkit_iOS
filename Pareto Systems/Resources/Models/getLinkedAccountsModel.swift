//
//	getLinkedAccountsModel.swift
//	Model file generated using JSONExport: https://github.com/Ahmed-Ali/JSONExport

import Foundation


class getLinkedAccountsModel : NSObject, NSCoding{

	var responseMessage : String!
	var results : [getLinkedAccountsResult]!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [getLinkedAccountsResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = getLinkedAccountsResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [getLinkedAccountsResult]
