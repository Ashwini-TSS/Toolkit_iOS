...
class companyAccountModel : NSObject, NSCoding{

	var responseMessage : String!
	var results : [companyAccountResult]!
	...
	init(fromDictionary dictionary: NSDictionary){
		...
		results = [companyAccountResult]()
		if let resultsArray = dictionary["Results"] as? [[String:Any]]{
			for dic in resultsArray{
				let value = companyAccountResult(fromDictionary: dic)
    ...
    */
    @objc required init(coder aDecoder: NSCoder)
	{
         ...
         results = aDecoder.decodeObject(forKey :"Results") as? [companyAccountResult]
