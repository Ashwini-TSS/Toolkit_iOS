...
class ServiceDeliverableModel : NSObject, NSCoding{

	var dataObject : ServiceDeliverableDataObject!
	...
	init(fromDictionary dictionary: NSDictionary){
		if let dataObjectData = dictionary["DataObject"] as? [String:Any]{
			dataObject = ServiceDeliverableDataObject(fromDictionary: dataObjectData)
		}
    ...
    */
	...
	{
         dataObject = aDecoder.decodeObject(forKey: "DataObject") as? ServiceDeliverableDataObject
